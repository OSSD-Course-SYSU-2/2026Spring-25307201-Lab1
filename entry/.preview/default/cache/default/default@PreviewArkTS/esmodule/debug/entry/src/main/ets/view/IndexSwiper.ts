...
export class SwiperVideo extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/IndexSwiper.ets(30:5)", "entry");
            Column.height("24.1%");
            Column.width("93.3%");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Swiper.create();
            Swiper.debugLine("entry/src/main/ets/view/IndexSwiper.ets(31:7)", "entry");
...
class SwiperItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/IndexSwiper.ets(61:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.imageSrc);
            Image.debugLine("entry/src/main/ets/view/IndexSwiper.ets(62:7)", "entry");
