...
export class VideoPlayer extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.previewUris = { "id": 16777252, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
        this.source = '';
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/VideoPlayer.ets(37:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Video.create({
                src: this.source,
            ...
            Video.debugLine("entry/src/main/ets/view/VideoPlayer.ets(38:7)", "entry");
            ...
            Video.onError(() => {
                this.getUIContext().getPromptAction().showToast({
                    ...
                    message: { "id": 16777259, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" }
                });
            });
        }, Video);
        {
