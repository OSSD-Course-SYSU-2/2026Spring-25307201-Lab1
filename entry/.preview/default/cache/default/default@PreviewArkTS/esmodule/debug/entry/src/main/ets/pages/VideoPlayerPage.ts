...
export class VideoPlayerPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.startIconResource = { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
        this.backIconResource = { "id": 16777250, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
    ...
    private initSampleComments(): void {
        const sampleComments = [
            new CommentItem('user1', '小明', { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" }, '这个视频太棒了！', '2小时前'),
            new CommentItem('user2', '小红', { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" }, '学到了很多新知识', '3小时前'),
            new CommentItem('user3', '小刚', { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" }, '期待更多内容', '5小时前')
        ];
    ...
    private handleSendComment(content: string): void {
        const newComment = new CommentItem('current_user', '我', { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" }, content, '刚刚');
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(163:7)", "entry");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 顶部导航栏
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(165:9)", "entry");
                    // 顶部导航栏
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(166:11)", "entry");
                    Image.width(24);
                    Image.height(24);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create({ "id": 16777257, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
                    Text.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(173:11)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(179:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 弹幕开关按钮
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(182:11)", "entry");
                    // 弹幕开关按钮
                    Row.margin({ right: 12 });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(this.showDanmaku ? '弹幕开' : '弹幕关');
                    Text.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(183:13)", "entry");
                    Text.fontColor(Color.White);
                    Text.fontSize(16);
                    Text.margin({ right: 8 });
                }, Text);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Circle.create();
                    Circle.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(187:13)", "entry");
                    Circle.width(40);
                    Circle.height(24);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 视频播放区域
                    Stack.create();
                    Stack.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(209:9)", "entry");
                    // 视频播放区域
                    ...
                    if (!this.videoPlayerModel.isPlay && !this.videoPlayerModel.isLoading) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Image.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(211:13)", "entry");
                                Image.width(50);
                                Image.height(50);
                                Image.zIndex(2);
                            }, Image);
                    ...
                    if (this.videoPlayerModel.isLoading) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Progress.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(217:13)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 底部控制栏
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(267:9)", "entry");
                    // 底部控制栏
                    Row.width(ALL_PERCENT);
                    // 底部控制栏
                    Row.height(60);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 评论按钮
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(269:11)", "entry");
                    // 评论按钮
                    Row.width(80);
                    // 评论按钮
                    Row.height(36);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('评论');
                    Text.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(270:13)", "entry");
                    Text.fontSize(14);
                    Text.fontColor(Color.White);
                    Text.margin({ right: 4 });
                }, Text);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(274:13)", "entry");
                    Text.fontSize(14);
                    Text.fontColor(Color.White);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 点赞按钮
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(288:11)", "entry");
                    // 点赞按钮
                    Row.width(80);
                    // 点赞按钮
                    Row.height(36);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create({ "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
                    Image.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(289:13)", "entry");
                    Image.width(16);
                    Image.height(16);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(294:13)", "entry");
                    Text.fontSize(14);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 不喜欢按钮
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(309:11)", "entry");
                    // 不喜欢按钮
                    Row.width(80);
                    // 不喜欢按钮
                    Row.height(36);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create({ "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
                    Image.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(310:13)", "entry");
                    Image.width(16);
                    Image.height(16);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(315:13)", "entry");
                    Text.fontSize(14);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/VideoPlayerPage.ets(162:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
