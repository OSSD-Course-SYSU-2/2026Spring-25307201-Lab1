...
export class VideoModule extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/IndexModule.ets(31:5)", "entry");
            Column.margin({
                left: "3.3%",
                right: "3.3%"
            });
            ...
            Column.backgroundColor({ "id": 16777249, "type": 10001, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Flex.create({ direction: FlexDirection.Row });
            Flex.debugLine("entry/src/main/ets/view/IndexModule.ets(32:7)", "entry");
            Flex.margin({
                left: "3.3%",
                bottom: 12,
                top: 12
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/IndexModule.ets(33:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/view/IndexModule.ets(43:7)", "entry");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("entry/src/main/ets/view/IndexModule.ets(45:11)", "entry");
                    };
...
class HorizontalItem extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__source = this.createStorageLink('source', '', "source");
        this.pathStack = new NavPathStack();
        this.imageSrc = { "id": 16777258, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
        this.videoName = '';
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/IndexModule.ets(82:5)", "entry");
            Column.justifyContent(FlexAlign.Center);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.imageSrc);
            Image.debugLine("entry/src/main/ets/view/IndexModule.ets(83:7)", "entry");
            Image.width(132);
            Image.height(94);
            Image.onClick(() => {
                this.source = NET;
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/IndexModule.ets(90:7)", "entry");
            Text.margin({
                top: 12,
                bottom: 12
            });
