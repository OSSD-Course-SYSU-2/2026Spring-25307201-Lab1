...
export class CommentItemView extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/CommentView.ets(28:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/CommentView.ets(30:7)", "entry");
            // 头像
            Image.width(40);
            // 头像
            Image.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/CommentView.ets(36:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 用户名和时间
            Row.create();
            Row.debugLine("entry/src/main/ets/view/CommentView.ets(38:9)", "entry");
            // 用户名和时间
            Row.width(ALL_PERCENT);
            // 用户名和时间
            Row.margin({ bottom: 6 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/CommentView.ets(39:11)", "entry");
            Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/view/CommentView.ets(44:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.comment.time);
            Text.debugLine("entry/src/main/ets/view/CommentView.ets(46:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999999');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/CommentView.ets(54:9)", "entry");
            // 评论内容
            Text.fontSize(16);
            // 评论内容
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 点赞数
            Row.create();
            Row.debugLine("entry/src/main/ets/view/CommentView.ets(59:9)", "entry");
            // 点赞数
            Row.onClick(() => {
                if (this.onLike) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.comment.isLiked ? { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" } : { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/view/CommentView.ets(60:11)", "entry");
            Image.width(16);
            Image.height(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/CommentView.ets(66:11)", "entry");
            Text.fontSize(12);
...
export class CommentView extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/CommentView.ets(99:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 评论标题
            Row.create();
            Row.debugLine("entry/src/main/ets/view/CommentView.ets(101:7)", "entry");
            // 评论标题
            Row.width(ALL_PERCENT);
            // 评论标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/CommentView.ets(102:9)", "entry");
            Text.fontSize(18);
            Text.fontColor('#FFFFFF');
            Text.fontWeight(COMMON_NUM_FONT_WEIGHT);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 评论列表
            List.create();
            List.debugLine("entry/src/main/ets/view/CommentView.ets(112:7)", "entry");
            // 评论列表
            ...
            const forEachItemGenFunction = _item => {
                const comment = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("entry/src/main/ets/view/CommentView.ets(114:11)", "entry");
                    };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 输入框
            Row.create();
            Row.debugLine("entry/src/main/ets/view/CommentView.ets(128:7)", "entry");
            // 输入框
            Row.width(ALL_PERCENT);
            // 输入框
            Row.padding(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/view/CommentView.ets(129:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/CommentView.ets(141:9)", "entry");
            Button.height(40);
