...
export class VideoSlider extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/view/VideoPlaySlider.ets(36:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.videoPlayerModel.isPlay ? { "id": 16777225, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" } : { "id": 16777221, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/view/VideoPlaySlider.ets(37:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/VideoPlaySlider.ets(44:7)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("entry/src/main/ets/view/VideoPlaySlider.ets(48:7)", "entry");
            Slider.blockColor({ "id": 16777249, "type": 10001, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
            Slider.width("46.7%");
            Slider.trackColor(Color.Gray);
            Slider.selectedColor({ "id": 16777249, "type": 10001, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/VideoPlaySlider.ets(66:7)", "entry");
            Text.fontSize(16);
